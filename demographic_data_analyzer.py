...
if __name__ == "__main__":
    ...
    # Note: You'll need the actual CSV file to run this
    try:
        result = calculate_demographic_data()
        print("\nFunction executed successfully!")
    except FileNotFoundError:
        print("CSV file not found. Please ensure 'adult.data.csv' is in the same directory.")
